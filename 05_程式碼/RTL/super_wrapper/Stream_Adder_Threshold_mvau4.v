...
// =====================================================================
// MVAU4 Stream_Adder_Threshold — PE=1 version
// OUT_CH=256
// =====================================================================
...
`ifdef SIM_INIT_ROM
    initial begin
        $readmemh("/home/barkie1/mvau_pipeline_runtime_3ds_pe1/mvau_adapter/mvau4/data/thresh_load.dat",      thresh_rom);
        $readmemh("/home/barkie1/mvau_pipeline_runtime_3ds_pe1/mvau_adapter/mvau4/data/sign_load.dat",        adp_sign_rom);
        $readmemh("/home/barkie1/mvau_pipeline_runtime_3ds_pe1/mvau_adapter/mvau4/data/contrib_lut_load.dat", adp_contrib_lut);
    end
`endif
