...
// =====================================================================
// Adapter_MVAU4 — PE=1 version, cfg-writable RAM
// IN_CH=128, OUT_CH=256, HIDDEN=32, IN_CHUNKS=4, UP_WIDTH=32
// =====================================================================

module Adapter_MVAU4 #(
    parameter LAYER_ID = 4,
    parameter IN_CH    = 128,
...
`ifdef SIM_INIT_ROM
    initial begin
        $readmemh("/home/barkie1/mvau_pipeline_runtime_3ds_pe1/mvau_adapter/mvau4/data/rom_rc_load.dat",   rom_rc);
        $readmemh("/home/barkie1/mvau_pipeline_runtime_3ds_pe1/mvau_adapter/mvau4/data/rom_down_load.dat", rom_down);
        $readmemh("/home/barkie1/mvau_pipeline_runtime_3ds_pe1/mvau_adapter/mvau4/data/rom_up_load.dat",   rom_up);
    end
`endif
