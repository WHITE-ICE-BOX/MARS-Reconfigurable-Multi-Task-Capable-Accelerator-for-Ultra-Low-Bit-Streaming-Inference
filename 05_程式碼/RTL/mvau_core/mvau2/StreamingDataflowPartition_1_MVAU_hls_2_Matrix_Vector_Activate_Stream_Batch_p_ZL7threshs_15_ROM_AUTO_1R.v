...
`endif
module StreamingDataflowPartition_1_MVAU_hls_2_Matrix_Vector_Activate_Stream_Batch_p_ZL7threshs_15_ROM_AUTO_1R (
    address0, ce0, q0, 
    reset, clk);
...
initial begin
    ...
    $readmemh({`MVAU2_THRESH_DIR, "/StreamingDataflowPartition_1_MVAU_hls_2_Matrix_Vector_Activate_Stream_Batch_p_ZL7threshs_15_ROM_AUTO_1R.dat"}, rom0);
end
