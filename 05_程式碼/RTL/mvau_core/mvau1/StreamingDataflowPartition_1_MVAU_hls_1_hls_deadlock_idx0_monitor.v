...
module StreamingDataflowPartition_1_MVAU_hls_1_hls_deadlock_idx0_monitor ( // for module StreamingDataflowPartition_1_MVAU_hls_1_StreamingDataflowPartition_1_MVAU_hls_1_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 StreamingDataflowPartition_1_MVAU_hls_1_hls_deadlock_idx1_monitor StreamingDataflowPartition_1_MVAU_hls_1_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
