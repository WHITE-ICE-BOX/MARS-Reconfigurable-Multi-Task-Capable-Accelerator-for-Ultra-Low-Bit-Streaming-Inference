...
// Stream_Adder_Threshold_mvau4 — multi-branch M=2, PE=4 (throughput),
...
module Stream_Adder_Threshold_mvau4 (
    ...
    localparam signed [31:0] ALPHA_Q8_B0 = 706;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B1 = 655;  // baked from checkpoint
