...
// Stream_Adder_Threshold_mvau3 — multi-branch M=4, PE=16 (throughput),
...
module Stream_Adder_Threshold_mvau3 (
    ...
    localparam signed [31:0] ALPHA_Q8_B0 = 921;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B1 = 962;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B2 = 909;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B3 = 919;  // baked from checkpoint
