...
// Stream_Adder_Threshold_mvau1 — multi-branch M=3, PE=32 (throughput),
...
module Stream_Adder_Threshold_mvau1 (
    ...
    localparam signed [31:0] ALPHA_Q8_B0 = 992;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B1 = 929;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B2 = 956;  // baked from checkpoint
