...
% 2. Title Info
% ==========================================================
\newcommand{\ZhTitle}{MARS：具多任務能力之超低位元串流推論可重組加速器架構}
\newcommand{\EnTitle}{MARS: A Reconfigurable Multi-Task-Capable Accelerator Architecture for Ultra-Low-Bit Streaming Inference}
\newcommand{\AuthorName}{Po-Chun Huang（黃柏鈞）}
\newcommand{\AdvisorA}{Pao-Ann Hsiung（熊博安）}
\newcommand{\AdvisorB}{Chun-Hsian Huang（黃駿賢）}
...
\AddToShipoutPictureBG{%
  \AtPageCenter{\makebox(0,0){\includegraphics[width=0.8\paperwidth]{assets_watermark_faded.png}}}%
}
