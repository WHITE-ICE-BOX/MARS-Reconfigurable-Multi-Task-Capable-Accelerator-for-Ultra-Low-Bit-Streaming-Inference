...
// Adapter system dump testbench - captures hardware output
module tb_MVAU_2_Dump;

    parameter MAX_IN_WORDS  = 200000;
    parameter TOTAL_OUTPUT_WORDS = 11520;
    ...
    wire [127:0] adapt_to_fifo_tdata, fifo_to_add_tdata;
    ...
    Simple_FIFO_mvau2 #(.WIDTH(128), .DEPTH_LOG2(12)) fifo_inst (
    ...
    initial begin
        ...
        dump_file = $fopen("/home/barkie1/mvau_pipeline/mvau_adapter/mvau2/golden_data/mvau2_adapter_hw_dump.dat", "w");
        in_ptr = 0;
