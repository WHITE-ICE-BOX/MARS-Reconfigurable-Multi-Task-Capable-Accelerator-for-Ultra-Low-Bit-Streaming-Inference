...
module tb_MVAU_3_Dump;

    parameter MAX_IN_WORDS  = 200000;
    parameter TOTAL_OUTPUT_WORDS = 8000;
    ...
    initial begin
        ...
        dump_file = $fopen("/home/barkie1/mvau_pipeline/mvau_adapter/mvau3/golden_data/mvau3_adapter_hw_dump.dat", "w");
        in_ptr = 0;

        ap_rst_n = 0; tb_in_tvalid = 0; tb_in_tdata = 0; tb_out_tready = 1;
        #100; ap_rst_n = 1; #50;

        $display("---- Adapter Dump MVAU3: Starting Data Feed ----");
        tb_in_tvalid = 1;
