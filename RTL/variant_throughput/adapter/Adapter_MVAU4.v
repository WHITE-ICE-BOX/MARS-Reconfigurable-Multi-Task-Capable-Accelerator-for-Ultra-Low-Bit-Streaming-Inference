// ===========================================================================
// [交接導向註解]
// 模組：第 4 層卷積 MVAU4 的 Conv-Adapter 資料路徑。流程：RTL。
...
module Adapter_MVAU4 #(
    ...
    // --- 權重檔案路徑 ---
    parameter DOWN_WEIGHT_FILE = "/home/barkie1/mvau_pipeline/mvau_adapter/mvau4/data/adapter_4_down_packed.dat",
    parameter UP_WEIGHT_FILE   = "/home/barkie1/mvau_pipeline/mvau_adapter/mvau4/data/adapter_4_up_packed.dat",
    parameter RC_FILE          = "/home/barkie1/mvau_pipeline/mvau_adapter/mvau4/data/adapter_4_rc.dat",
