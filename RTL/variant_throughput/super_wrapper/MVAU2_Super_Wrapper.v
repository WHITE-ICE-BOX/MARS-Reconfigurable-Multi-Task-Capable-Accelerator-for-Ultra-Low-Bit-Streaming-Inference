...
module MVAU2_Super_Wrapper (
    ...
    // 1. 分流器 (Splitter): 將 32-bit 輸入完美複製給 MVAU2 和 Adapter
    ...
    // 3. Adapter IP (MVAU2 專用 128-bit 版)
    ...
    // 5. 加法與門檻值模組 (MVAU2 專用真 3-Stage Pipeline 版)
