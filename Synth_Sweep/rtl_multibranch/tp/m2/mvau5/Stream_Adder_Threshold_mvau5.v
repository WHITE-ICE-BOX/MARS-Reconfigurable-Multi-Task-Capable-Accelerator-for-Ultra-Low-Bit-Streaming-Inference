...
// Stream_Adder_Threshold_mvau5 — multi-branch M=2, PE=1 (tp).
...
module Stream_Adder_Threshold_mvau5 (
    ...
    localparam signed [31:0] ALPHA_Q8_B0 = 801;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B1 = 775;  // baked from checkpoint
    ...
    wire signed [31:0] contrib_sum_s1 = s1_adp_contrib_b0 + s1_adp_contrib_b1;
