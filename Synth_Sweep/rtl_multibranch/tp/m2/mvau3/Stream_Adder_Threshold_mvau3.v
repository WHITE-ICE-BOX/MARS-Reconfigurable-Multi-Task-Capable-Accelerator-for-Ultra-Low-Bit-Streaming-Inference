...
// Stream_Adder_Threshold_mvau3 — multi-branch M=2, PE=16 (throughput),
...
module Stream_Adder_Threshold_mvau3 (
    ...
    localparam signed [31:0] ALPHA_Q8_B0 = 1413;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B1 = 1397;  // baked from checkpoint
