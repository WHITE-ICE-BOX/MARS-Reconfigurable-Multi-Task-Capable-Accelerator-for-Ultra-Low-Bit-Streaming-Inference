...
// Stream_Adder_Threshold_mvau2 — multi-branch M=2, PE=16 (throughput),
...
module Stream_Adder_Threshold_mvau2 (
    ...
    localparam signed [31:0] ALPHA_Q8_B0 = 361;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B1 = 354;  // baked from checkpoint
