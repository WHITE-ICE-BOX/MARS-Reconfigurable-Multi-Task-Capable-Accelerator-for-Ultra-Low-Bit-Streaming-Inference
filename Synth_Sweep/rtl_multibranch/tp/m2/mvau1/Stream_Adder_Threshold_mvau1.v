...
// Stream_Adder_Threshold_mvau1 — multi-branch M=2, PE=32 (throughput),
...
module Stream_Adder_Threshold_mvau1 (
    ...
    localparam signed [31:0] ALPHA_Q8_B0 = 1149;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B1 = 1152;  // baked from checkpoint

    reg [0:0] step_cnt;

    wire stall = m_axis_tvalid && !m_axis_tready;
    wire all_br_valid = s_axis_2_b0_tvalid && s_axis_2_b1_tvalid;
    wire in_fire = s_axis_1_tvalid && all_br_valid && !stall;
    assign s_axis_1_tready = !stall && all_br_valid;
    assign s_axis_2_b0_tready = !stall && s_axis_1_tvalid && s_axis_2_b1_tvalid;
    assign s_axis_2_b1_tready = !stall && s_axis_1_tvalid && s_axis_2_b0_tvalid;
    ...
    generate
        for (gp = 0; gp < PE; gp = gp + 1) begin : g_lane
            ...
            wire signed [31:0] contrib_sum = s1_contrib_b0 + s1_contrib_b1;
