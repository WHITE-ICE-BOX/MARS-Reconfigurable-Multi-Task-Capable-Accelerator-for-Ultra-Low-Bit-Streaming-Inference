...
// Stream_Adder_Threshold_mvau4 — multi-branch M=3, PE=4 (throughput),
...
module Stream_Adder_Threshold_mvau4 (
    ...
    localparam signed [31:0] ALPHA_Q8_B0 = 586;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B1 = 583;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B2 = 590;  // baked from checkpoint
