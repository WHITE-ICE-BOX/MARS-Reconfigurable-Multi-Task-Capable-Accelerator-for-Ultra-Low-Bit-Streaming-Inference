...
// Stream_Adder_Threshold_mvau2 — multi-branch M=3, PE=16 (throughput),
...
module Stream_Adder_Threshold_mvau2 (
    ...
    localparam signed [31:0] ALPHA_Q8_B0 = 311;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B1 = 351;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B2 = 378;  // baked from checkpoint
