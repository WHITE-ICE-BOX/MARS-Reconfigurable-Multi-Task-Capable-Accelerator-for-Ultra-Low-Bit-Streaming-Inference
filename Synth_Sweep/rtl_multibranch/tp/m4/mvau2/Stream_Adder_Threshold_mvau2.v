...
// Stream_Adder_Threshold_mvau2 — multi-branch M=4, PE=16 (throughput),
...
module Stream_Adder_Threshold_mvau2 (
    ...
    input  wire [127:0]          s_axis_2_b3_tdata,
    ...
    localparam signed [31:0] ALPHA_Q8_B0 = 268;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B1 = 351;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B2 = 261;  // baked from checkpoint
    localparam signed [31:0] ALPHA_Q8_B3 = 317;  // baked from checkpoint
